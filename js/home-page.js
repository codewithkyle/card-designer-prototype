import{html as t,render as e}from"./lit-html.js";import i from"./css.js";class l extends HTMLElement{constructor(){super();i(["homepage"]).then(()=>{this.render()})}render(){const a=t`
